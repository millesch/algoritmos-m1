...
public class Erosion {
	public static void main(String args[]) throws IOException {
		...
		imageErosion = erosion(image);

		Util.showBufferedImages(image, imageErosion);
		Util.writeImageOnFile(imageErosion, "src/output/erosion.png");
	}
	...
	public static BufferedImage erosion(BufferedImage image) {
		...
		BufferedImage imageErosion = new BufferedImage(width, height, image.getType());
